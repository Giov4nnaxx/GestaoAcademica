...
//        atualizarSigla(idAtualizar);
    ...
    private static void cadastrarAluno() {
        ...
        LocalDate dataNascimento= LocalDate.parse(Leitura.dados("Digite a data de nascimento: "));
        Turma turma = listarTurmasIndiceSigla();
